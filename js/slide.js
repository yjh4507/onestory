...
$.ajax({
  ...
  .done(function (msg) {
    var boxs = document.getElementsByClassName('box');
    for (var i = 0; i < boxs.length; i++) {
      $(".sec3_box>.box3").eq(i).prepend("<img src ='" + msg.documents[i].thumbnail + "'/>");
      $(".sec3_box>.box3").eq(i).children(".box3_text").append("<h4>" + msg.documents[i].title + "</h4>");
      $(".sec3_box>.box3").eq(i).children(".box3_text").append("<p>" + msg.documents[i].authors + "</p>");
    }
  });